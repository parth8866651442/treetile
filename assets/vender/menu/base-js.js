...
(function (e) {
    e(function () {
        ...
        e(".rgdev").append(e('<div class="rgdev-text"></div>'));
        e(".rgdev-item").has("ul").prepend('<span class="rgdev-click"><i class="rgdev-arrow"></i></span>');
        e(".rgdev-items").has("ul").prepend('<span class="rgdev-click"><i class="rgdev-arrow"></i></span>');
        e(".rgdev-submenu-item").has("ul").prepend('<span class="rgdev-click"><i class="rgdev-arrow"></i></span>');
        e(".rgdev-submenu-items").has("ul").prepend('<span class="rgdev-click"><i class="rgdev-arrow"></i></span>');
        e(".rgdev-submenu-item-sub").has("ul").prepend('<span class="rgdev-click"><i class="rgdev-arrow"></i></span>');
        e(".rgdev-submenu-item-subs").has("ul").prepend('<span class="rgdev-click"><i class="rgdev-arrow"></i></span>');
        ...
        e(".rgdev-click").click(function () {
            ...
            e(this).siblings(".rgdev-submenus").slideToggle("slow");
            e(this).children(".rgdev-arrow").toggleClass("rgdev-rotate");
            e(this).siblings(".rgdev-submenu-sub").slideToggle("slow");
            e(this).siblings(".rgdev-submenu-subs").slideToggle("slow");
            e(this).siblings(".rgdev-submenu-sub-sub").slideToggle("slow");
            e(this).siblings(".rgdev-submenu-sub-subs").slideToggle("slow")
        })
    })
})(jQuery) /*rgdev~30x9x87*/
