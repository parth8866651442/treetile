...
<div class="container">
  ...
  <div class="content-block" role="main">
    <ul class="breadcrumb">
      ...
      <li class="active">Domestic Contact</li>
    </ul>
    <div class="row-fluid">
      <article class="span12 data-block nested">
        <div class="data-container">
          <header>
            <h2>Domestic Contact </h2>
            <br>
            <br>
            <hr>
          </header>
            ...
            <div class="tab-pane active" id="newUser">
              <?php 
			   if(isset($_POST['submit']) && $_POST['submit'] == 'create'){ 
									...
									echo "<script>urlRefresh('domesticcontact.php');</script>";
								}
              ...
              <form id="myForm" class="form-horizontal" method="post" action="#">
                ...
                <div class="control-group" >
                  ...
                  <div class="controls">
                    <textarea id="address" name="address" class="input-xxlarge" type="text" rows="6" />
                    <?php echo (isset($psdata['address'])) ? $psdata['address'] : '';  ?>
                    </textarea>
                  </div>
                </div>
                <div class="control-group" >
                  ...
                  <div class="controls">
                    <input type="text" class="input-xxlarge" id="subname" name="mobile" value="<?php echo (isset($psdata['mobile'])) ? $psdata['mobile'] : '';  ?>" required>
                  </div>
                </div>
                <div class="control-group" >
                  <label for="fileInput" class="control-label">Email </label>
                  <div class="controls">
                    <input type="text"  class="input-xxlarge" id="email" name="email" value="<?php echo (isset($psdata['email'])) ? $psdata['email'] : '';  ?>">
                  </div>
                </div>
                <div class="control-group" >
                  ...
                  <div class="controls">
                    ...
                    <br/>
                    <br/>
                    <p> - Write Embed Map Link After pb Variable...<br/>
                    </p>
                    <textarea id="map2" name="map2" class="input-xxlarge" type="text" rows="8" readonly />Ex-"!1m18!1m12!1m3!1d58846.91597688007!2d70.82177582881087!3d22.804974226203097!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39598cd96ce15487%3A0x294863999340c94e!2sMorbi%2C+Gujarat!5e0!3m2!1sen!2sin!4v1557813207908!5m2!1sen!2sin"
                    </textarea>
                  </div>
                </div>
                ...
                <table class="table table-striped table-bordered" id="catalogueview" align="center">
                  ...
                  <tbody>
                    ...
                    <tr class="odd gradeX" id="<?php echo $v['id']; ?>">
                      ...
                      <td>
                      <?php if($v['map'] != '') { ?>
                      <iframe src="https://www.google.com/maps/embed?pb=<?php echo base64_decode($v['map']); ?>" width="100%" height="200" frameborder="0" style="border:0" allowfullscreen></iframe></td>
                      <?php } else { echo '-';  } ?>
                        </th>
                      <td align="center"><a href="domesticcontact.php?action=update&id=<?php echo $v['id']; ?>" class="btn btn-alt btn-primary" >Edit</a> <a class="btn btn-alt btn-danger" onClick="deleteAlert(<?php echo $v['id']; ?>)">Delete</a></td>
                    </tr>
                    <?php }?>
                  </tbody>
                </table>
...
<script type="text/javascript">
	 jQuery(document).ready(function($) {
		...
		$('.dynamic-menu #Domesticcontact').addClass('active');
	});
</script> 
