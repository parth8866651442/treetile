    ...
    <header class="Dashboard-header">
        <ul class="FlexGrid">
            <li class="FlexGrid-item">
                <div class="Titles">
                  	<h1 id="view-name" class="Titles-main"></h1>
                  	<div class="Titles-sub" id="embed-api-auth-container"></div>
                </div>
            </li>
            <li class="FlexGrid-item FlexGrid-item--fixed"><div id="active-users-container"><div class="ActiveUsers">Active Users: <b class="ActiveUsers-value">0</b></div></div></li>
        </ul>
    ...
    <ul class="FlexGrid FlexGrid--halves">
   		<li class="FlexGrid-item">
        	<div class="Chartjs">
            	...
            	<figure id="chart-1-container" class="Chartjs-figure"></figure>
        ...
        <li class="FlexGrid-item">
          	<div class="Chartjs">
            	...
            	<figure id="chart-2-container" class="Chartjs-figure"></figure>
        ...
        <li class="FlexGrid-item">
          	<div class="Chartjs">
                ...
                <figure id="chart-3-container" class="Chartjs-figure"></figure>
        ...
        <li class="FlexGrid-item">
          	<div class="Chartjs">
            	...
            	<figure id="chart-4-container" class="Chartjs-figure"></figure>
...
gapi.analytics.ready(function() {
  ...
  gapi.analytics.auth.authorize({
    ...
    clientid: '841561129949-uc0pcto81a4oerh0g0qjjuieggimjpvg.apps.googleusercontent.com'
  });
