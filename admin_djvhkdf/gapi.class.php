...
class gapi {
  ...
  const real_time_url = 'https://www.googleapis.com/analytics/v3/data/realtime';
  ...
  public function realTimeReportData($report_id, $dimensions=null, $metrics, $sort_metric=null, $filter=null, $start_date=null, $end_date=null, $start_index=1, $max_results=10000) {
    ...
    $url = new gapiRequest(gapi::real_time_url);
