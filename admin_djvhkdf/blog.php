	...
	<div class="container">
		...
		<div class="content-block" role="main">
			<ul class="breadcrumb">
				...
				<li>All Inquiry </li>
				<li class="active">Blog Inquiry</li>
			</ul>
			<div class="row-fluid">
					...
					<div class="data-container">
						<header>
							...
							<div style="float:right;">
								<h2>Export</h2>
								<a style="padding:15px; position:relative; top:5px; margin-top:5px;" href="excel/contactinquiry.php" id="exportToExcel">
						...
						<section class="tab-content">
							<div class="tab-pane active" id="horizontal">
								<?php if(isset($_POST) && isset($_POST['Contact_delete']) && $_POST['Contact_delete'] !='')
								{
									
									foreach($_POST['iq_delete'] as $id)
									{
										$obj_fun->deleteRecordById('blog_inquiry',$id);
									}
									header('location:blog.php');	
								}
								?>
								<form method="post" action="#">
									<input type="submit" name="Contact_delete" id="Contact_delete" value="Delete" class="btn btn-alt btn-primary" style="position: absolute; right: 290px;" onClick="return confirm('Are You Sure You Want To Delete?');"/>
									<table class="datatable table table-striped table-bordered viewblogclass" id="example">
										...
										<tbody>
											...
											$sql = "SELECT * FROM `blog_inquiry` " . $where . " ORDER BY `id` desc";
...
<script type="text/javascript">
	jQuery( document ).ready( function ( $ ) {
		...
		$( '.dynamic-menu #contact' ).addClass( 'active' );
	} );
</script>
