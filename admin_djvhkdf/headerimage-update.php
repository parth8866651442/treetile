...
<body class="fixed-layout">
	<div class="container">
		...
		<div class="content-block" role="main">
			...
			{
				$sql = "select * from product_size where id =".$_GET['id'];
				$header_image_data = $obj_fun->getLastRecords($sql);
				
				$mname = "SELECT * FROM `menu` where id=".$header_image_data['menu_id'];
				...
				<article class="span12 data-block nested">
					<div class="data-container">
						...
						<section class="tab-content">
							...
							<form id="myFormUpdate" class="form-horizontal" method="post" enctype="multipart/form-data" onSubmit="return catalogue_update_validate();" action="progress_headerimage-update.php">
									
									<div class="control-group" >
										<label for="fileInput" class="control-label" >Menu Name</label>	
										<div class="controls">
											<p style="margin-top:5px;"><?php echo $name ?></p>
										</div>
									</div>
									...
									<div class="control-group" >
										...
										<div class="controls">
											<p style="margin-top:5px;"><?php echo (isset($header_image_data['size']) && $header_image_data['size'] !='' ? $header_image_data['size'] : '');?></p>
