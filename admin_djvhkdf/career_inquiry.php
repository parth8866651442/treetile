	...
	<div class="container">
		...
		<div class="content-block" role="main">
			<ul class="breadcrumb">
				...
				<li>All Inquiry </li>
				<li class="active">Career Inquiry</li>
			</ul>
			<div class="row-fluid">
				<article class="span12 data-block">
					<div class="data-container">
						<header>
							<h2>Career Inquiry</h2>
							<div style="float:right;">
								<h2>Export</h2>
								<a style="padding:15px; position:relative; top:5px; margin-top:5px;" href="excel/careerinquiry.php" id="exportToExcel">
						...
						<section class="tab-content">
							<div class="tab-pane active" id="horizontal">
								<?php if(isset($_POST) && isset($_POST['Career_delete']) && $_POST['Career_delete'] !='')
								{
									
									foreach($_POST['iq_delete'] as $id)
									{
										$obj_fun->deleteRecordById('career_inquiry',$id);
									}
									header('location:career_inquiry.php');	
								}
								?>
								<form method="post" action="#">
									<input type="submit" name="Career_delete" id="Career_delete" value="Delete" class="btn btn-alt btn-primary" style="position: absolute; right: 290px;" onClick="return confirm('Are You Sure You Want To Delete?');"/>
									<table class="datatable table table-striped table-bordered viewblogclass" id="example">
										...
										<tbody>
											...
											$sql = "SELECT * FROM `career_inquiry` " . $where . " ORDER BY `id` desc";
											...
											<tr class="gradeX">
												...
												<td>
													<?php echo $c['experience']; ?>
												</td>
												<td>
													<?php echo $c['c_address']; ?>
												</td>
												 <td><a href="../<?php echo $c['cv_file'] ?>" style="font-size: 11px" target="_blank" class="btn btn-alt btn-primary"> Download  </a>
                                              </td>
												<td>
													<?php echo $c['ip']; ?>
												</td>
...
<script type="text/javascript">
	jQuery( document ).ready( function ( $ ) {
		...
		$( '.dynamic-menu #cinquiry' ).addClass( 'active' );
	} );
</script>
