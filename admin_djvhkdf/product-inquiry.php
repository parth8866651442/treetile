					...
					<div class="data-container">
						<header>
							...
							<div style="float:right;">
								<h2>Export</h2>
								<a style="padding:15px; position:relative; top:5px; margin-top:5px;" href="excel/productinquiry.php" id="exportToExcel">
						...
						<section class="tab-content">
							<div class="tab-pane active" id="horizontal">
								<?php if(isset($_POST) && isset($_POST['Product_delete']) && $_POST['Product_delete'] !='')
								{
									...
									{
										$obj_fun->deleteRecordById('product_inquiry',$id);
									}
									header('location:product-inquiry.php');	
								}
								?>
								<form method="post" action="#">
									<input type="submit" name="Product_delete" id="Product_delete" value="Delete" class="btn btn-alt btn-primary" style="position: absolute; right: 290px;" onClick="return confirm('Are You Sure You Want To Delete?');"/>
									<table class="datatable table table-striped table-bordered viewblogclass" id="example">
										...
										<tbody>
											...
											$sql = "SELECT * FROM `product_inquiry` " . $where . " ORDER BY `id` desc";
...
<script type="text/javascript">
	jQuery( document ).ready( function ( $ ) {
		...
		$( '.dynamic-menu #pcontact' ).addClass( 'active' );
	} );
</script>
