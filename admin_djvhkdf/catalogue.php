					...
					<div class="data-container">
						...
						<section class="tab-content">
							<div class="tab-pane active" id="newUser">
								<form id="myForm" class="form-horizontal" method="post" enctype="multipart/form-data" onSubmit="return catalogue_validate();" action="progress.php">
                                    ...
                                    <div class="control-group">
										<label for="fileInput" class="control-label">Menu Size</label>
										<div class="controls" style="margin-left: 180px;">
									...
									<table class="datatable table table-striped table-bordered" id="catalogueview" align="center">
										...
										<tbody>
											...
											<tr class="odd gradeX" id="<?php echo $v['id']; ?>">
												...
												<?php } ?>
												<td align="center">
													<a href="../uploads/catalogue/<?php echo $v['pdf']; ?>" target="_blank" class="btn btn-alt btn-primary">View</a>
												</td>
												<td>
													<?php 
														if($v['status'] == 0){ 
