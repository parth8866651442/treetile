...
<body class="fixed-layout">
	<div class="container">
		...
		<div class="content-block" role="main">
			...
			<div class="row-fluid">
				<article class="span12 data-block nested">
					<div class="data-container">
						<header>
							<h2>Add Certificate ( for better resolution keep Image size <?php echo certificate_th_width;?> x <?php echo certificate_th_height;?> px )</h2>
							<br><br>
							<hr>
						</header>
						<section class="tab-content">
							<div class="tab-pane active" id="newUser">
								<form id="myForm" class="form-horizontal" method="post" enctype="multipart/form-data" onSubmit="return catalogue_validate();" action="cprogress.php">
										...
										<div class="controls">
											<div data-provides="fileupload" class="fileupload fileupload-new">
												<div class="input-append">
													...
													</div><span class="btn btn-alt btn-file"><span class="fileupload-new">Select Image</span><span class="fileupload-exists">Change</span><input type="file" name="image" id="image" required="">
													</span>
												</div>
											</div>
										</div>
			...
			<?php $cat = $obj_fun->getCertificate();
				if(isset($cat) && $cat !=''){
			?>
			<div class="row-fluid">
						...
						if ( isset( $_POST[ 'delete' ] ) && $_POST[ 'delete' ] != '' ) {
							if ( isset( $_POST[ 'cat_delete' ] ) && $_POST[ 'cat_delete' ] != '' ) {
								for ( $i = 0; $i < count( $_POST[ 'cat_delete' ] ); $i++ ) {
									$obj_fun->deleteCertificate( $_POST[ 'cat_delete' ][ $i ] );
									...
									<table class="datatable table table-striped table-bordered" id="catalogueview" align="center">
										...
										<tbody>
											...
											<tr class="odd gradeX" id="<?php echo $v['id']; ?>">
												...
												<?php /*<td><?php echo $v['name']; ?></td> */?>

                                                
												<td><img src="../uploads/certificate/<?php echo $v['image']; ?>" style="width: 170px;"/>
												</td>
												...
												<td align="center">
													<a href="certificate-update.php?id=<?php echo $v['id']; ?>" class="btn btn-alt btn-primary">Edit</a>
												</td>
