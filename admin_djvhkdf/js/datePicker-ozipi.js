...
(function ($) {
  ...
  datepick = function () {
    var ids = {},
      views = {
        years: 'datepickViewYears',
        moths: 'datepickViewMonths',
        days:  'datepickViewDays'
      },
      tpl = {
        wrapper: '<div class="datepick"><div class="datepickBorderT" /><div class="datepickBorderB" /><div class="datepickBorderL" /><div class="datepickBorderR" /><div class="datepickBorderTL" /><div class="datepickBorderTR" /><div class="datepickBorderBL" /><div class="datepickBorderBR" /><div class="datepickContainer"><table cellspacing="0" cellpadding="0"><tbody><tr></tr></tbody></table></div></div>',
        head: [
      ...
      layout = function(el) {
        ...
        }).find('div.datepickContainer').css({
          width: width + 'px',
          height: height + 'px'
        });
      },
      ...
      click = function(ev) {
        ...
        if (el.is('a')) {
          ev.target.blur();
          //if (el.hasClass('datepickDisabled')) {
            //return false;
          //}
          ...
          if (parentEl.is('th')) {
            ...
            if (el.hasClass('datepickMonth')) {
              ...
              if(options.mode == 'range') {
                ...
                if(tblEl.eq(0).hasClass('datepickViewDays')) {
                  tblEl.eq(0).toggleClass('datepickViewDays datepickViewMonths');
                  el.find('span').text(tmp.getFullYear());
                } else if(tblEl.eq(0).hasClass('datepickViewMonths')) {
                  tblEl.eq(0).toggleClass('datepickViewMonths datepickViewYears');
                  el.find('span').text((tmp.getFullYear()-6) + ' - ' + (tmp.getFullYear()+5));
                } else if(tblEl.eq(0).hasClass('datepickViewYears')) {
                  tblEl.eq(0).toggleClass('datepickViewYears datepickViewDays');
              ...
              if(tblEl.eq(0).hasClass('datepickViewDays')) {
                ...
                options.current.addYears(el.hasClass('datepickGoPrev') ? -1 : 1);
              } else if(tblEl.eq(0).hasClass('datepickViewYears')) {
                options.current.addYears(el.hasClass('datepickGoPrev') ? -12 : 12);
              }
              fillIt = true;
            }
            ...
            if(tblEl.eq(0).hasClass('datepickViewMonths')) {
              ...
              tblEl.eq(0).toggleClass('datepickViewYears datepickViewMonths');
            } else {
              // clicked a day cell
      ...
      /**
       * Bound to the HTML datepick element when it's not inline, and also 
       * can be called directly to show the bound datepick.  A datepick
       * calendar shown with this method will hide on a mouseclick outside
       * of the calendar.
       * 
       * Method is not applicable for inline datepicks
       */
      show = function (ev) {
