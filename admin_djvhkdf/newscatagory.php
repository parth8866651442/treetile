	...
	<div class="container">
		...
		<div class="content-block" role="main">
			<ul class="breadcrumb">
				...
				<li class="active">Add Event Catagory</li>
			</ul>
			<div class="row-fluid">
						...
						<section class="tab-content">
                            ...
                            <?php 
								if(isset($_POST['submit']) && $_POST['submit'] == 'create'){ 
									$obj_fun->insertcat($_POST);
									echo '<script>success("Catagory Insert successfully.")</script>';
									echo "<script>urlRefresh('newscatagory.php');</script>";
								}
								if(isset($_POST['submit']) && $_POST['submit'] == 'update' && isset($_GET['id']) && $_GET['id'] != ''){ 
								
								 $psdata = $obj_fun->getcatdata($_GET['id']);
									 
									 
									 $obj_fun->updatecat($_POST,$_GET['id']);
									echo '<script>success("CatagoryUpdate successfully.")</script>';
									echo "<script>urlRefresh('newscatagory.php');</script>";
								}
								?>
							...
							<form id="myForm" class="form-horizontal" method="post" action="#" enctype="multipart/form-data">
								...
								<?php }	?>
									...
									<div class="control-group" >
										<label for="fileInput" class="control-label">Catagory Name</label>	
										...
										<table class="datatable table table-striped table-bordered" id="catalogueview" align="center">
											...
											<tbody>
												...
												<tr class="odd gradeX" id="<?php echo $v['id']; ?>">
													...
													<td align="center">
														<a href="newscatagory.php?action=update&id=<?php echo $v['id']; ?>" class="btn btn-alt btn-primary" >Edit</a>										
	...
	<script>
		function deleteAlert( id ) {
			swal( {
					...
					text: "All Data will be remove in this Catagory.",
					type: "warning",
				...
				function ( isConfirm ) {
					if ( isConfirm ) {
						$.post( "custom-ajax.php", {
							action: 'newscat_delete',
							id: id
						}, function ( result ) {
							swal( "Deleted!", "Catagory", "success" );
							location.reload();
						} );
					} else {
...
function deleteAlertmega() {
			swal( {
					title: "Are you sure want to delete Checked Catagory?",
					text: "All Data will be remove in this Checked Catagory.",
					type: "warning",
					showCancelButton: true,
					confirmButtonColor: "#DD6B55",
					confirmButtonText: "Yes, Delete!",
